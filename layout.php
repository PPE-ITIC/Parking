<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato:700|Noto+Serif" rel="stylesheet">
...
<body>
    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="50">
        <nav class="navbar navbar-inverse" data-spy="affix" data-offset-top="197">
          ...
          <a class="navbar-brand" href="#"><img src="images/logoVoiture.jpg" alt="LoveCar" style="height:5px;width:5px;"></a>
               
                </div>
                <div>
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            <li><a href="#section1">Le concept</a></li>
                            <li><a href="#section2">S'inscrire</a></li>
                            <li><a href="#section3">Avis</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="formulaire">
            <div class="container">
                ...
                <form class="form-signin">
                    ...
                    <img class="mb-4" src="images/logoVoiture.jpg" alt="" width="72" height="72">
                    ...
                    <input type="email" id="inputPassword" class="form-control" placeholder="Confirmation Mail" required>
          ...
          <input type="checkbox" value="remember-me"> Remember me
                ...
                <div class="col-md-6 imgAnimate">
                    <img src="images/car2.png" style="height:250px;width:250px;">
                </div>
